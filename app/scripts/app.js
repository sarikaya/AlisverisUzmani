...
angular.module('asistanApp', []).config(function ($routeProvider) {
    ...
    $routeProvider
        ...
        .when('/product/:barcode', {
            ...
            resolve: { // XXX: use inline annotation temporarily until ngmin implement it
                resp: ['$route', '$http', '$q', 'geolocation',
                function ($route, $http, $q, geolocation) {
...
angular.module('asistanApp').run(function ($rootScope) {
